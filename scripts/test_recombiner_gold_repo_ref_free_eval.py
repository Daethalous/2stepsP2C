...
def main() -> None:
    ...
    parser.add_argument(
        ...
        help="Gold repo directory to be evaluated under ref-free setting.",
    )
    parser.add_argument(
        "--pdf_json_path",
        type=str,
    ...
    parser.add_argument(
        "--eval_result_dir",
        type=str,
        default=os.path.join("outputs", "RECOMBINER_gold_repo_ref_free_eval_results"),
    )
    parser.add_argument(
        "--run_tag",
        type=str,
    ...
    default_eval_result_dir = os.path.join("outputs", "RECOMBINER_gold_repo_ref_free_eval_results")
